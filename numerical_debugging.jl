...
# SAT_tilde_1 
s25 = reshape((T_11_1 .- Z_11_1)' * (e_1 * H_1 * (e_1T)) * u1_filter * u_analy, Nx, Ny, Nz)
s26 = reshape((T_11_1 .- Z_11_1)' * (e_1 * H_1 * g₁¹[:]), Nx, Ny, Nz)

s27 = reshape((T_21_1 .- Z_21_1)' * (e_1 * H_1 * (e_1T)) * u2_filter * u_analy, Nx, Ny, Nz)
s28 = reshape((T_21_1 .- Z_21_1)' * (e_1 * H_1 * g₂¹[:]), Nx, Ny, Nz)

s29 = reshape((T_31_1 .- Z_31_1)' * (e_1 * H_1 * (e_1T)) * u3_filter * u_analy, Nx, Ny, Nz)
s30 = reshape((T_31_1 .- Z_31_1)' * (e_1 * H_1 * g₃¹[:]), Nx, Ny, Nz)

s31 = reshape((T_11_2 .- Z_11_2)' * (e_2 * H_2 * (e_2T)) * u1_filter * u_analy, Nx, Ny, Nz)
s32 = reshape((T_11_2 .- Z_11_2)' * (e_2 * H_2 * g₁²[:]), Nx, Ny, Nz)

s33 = reshape((T_21_2 .- Z_21_2)' * (e_2 * H_2 * (e_2T)) * u2_filter * u_analy, Nx, Ny, Nz)
s34 = reshape((T_21_2 .- Z_21_2)' * (e_2 * H_2 * g₂²[:]), Nx, Ny, Nz)

s35 = reshape((T_31_2 .- Z_31_2)' * (e_2 * H_2 * (e_2T)) * u3_filter * u_analy, Nx, Ny, Nz)
s36 = reshape((T_31_2 .- Z_31_2)' * (e_2 * H_2 * g₃²[:]), Nx, Ny, Nz)
# SAT_tilde_2 
s37 = reshape((T_12_1 .- Z_12_1)' * (e_1 * H_1 * (e_1T)) * u1_filter * u_analy, Nx, Ny, Nz)
s38 = reshape((T_12_1 .- Z_12_1)' * (e_1 * H_1 * g₁¹[:]), Nx, Ny, Nz)

s39 = reshape((T_22_1 .- Z_22_1)' * (e_1 * H_1 * (e_1T)) * u2_filter * u_analy, Nx, Ny, Nz)
s40 = reshape((T_22_1 .- Z_22_1)' * (e_1 * H_1 * g₂¹[:]), Nx, Ny, Nz)

s41 = reshape((T_32_1 .- Z_32_1)' * (e_1 * H_1 * (e_1T)) * u3_filter * u_analy, Nx, Ny, Nz)
s42 = reshape((T_32_1 .- Z_32_1)' * (e_1 * H_1 * g₃¹[:]), Nx, Ny, Nz)

s43 = reshape((T_12_2 .- Z_12_2)' * (e_2 * H_2 * (e_2T)) * u1_filter * u_analy, Nx, Ny, Nz)
