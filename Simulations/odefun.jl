...
function odefun(dψV, ψδ, odeparam, t)
    ...
    (V2_tmp, V3_tmp, _, _, iter) = newtbndv_vectorized(rateandstate_vectorized, V2_v, V3_v, ψ, σn, Vector(τ2), Vector(τ3), RSas, η, RSV0; ftol=1e-12, maxiter=100, atolx=1e-4, rtolx=1e-4)
    V2_v .= V2_tmp
    V3_v .= V3_tmp
    @show iter
